  ...
  return (
    <section className=" px-6 mb-20 w-full flex flex-col items-center justify-center relative">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-auto mb-6">
...
const StatItem: React.FC<{ value: string; label: string }> = ({
  ...
  <div className="font-kirsty  font-medium flex flex-col items-center justify-center group p-8 rounded-2xl transition-all duration-500 hover:bg-white/[0.02]">
    <span className="text-6xl md:text-[4.5rem] font-black text-yellow-500 transition-all duration-500 group-hover:scale-105 group-hover:drop-shadow-[0_0_30px_rgba(234,179,8,0.4)]">
      {value}
    </span>
