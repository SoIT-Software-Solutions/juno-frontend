...
const availableEvents = [
  {
    ...
    img: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?q=80&w=500&auto=format&fit=crop",
  },
  {
    id: 2,
    name: "Paper Presentation",
        ...
        <form className="space-y-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <p className="text-[10px] tracking-[0.2em] text-white/60 font-bold uppercase">
                Under Graduate
              </p>
          ...
          {/* Submit */}
          <div className="flex flex-col space-y-4 items-center justify-center pt-10">
            <button
              type="submit"
            ...
            <p>* ₹100 per person will be collected at the event</p>
          </div>
        </form>
      </div>
    </div>
...
const FormInput: React.FC<{
  ...
  <div className="flex flex-col space-y-4">
    ...
    <input
      ...
      className="bg-black/40 border border-white/20 rounded-xl px-6 py-5 text-xs tracking-[0.2em] font-bold text-[var(--gold)] placeholder-white/60 outline-none focus:border-[var(--gold)] focus:bg-black/60 transition-all uppercase"
    />
  </div>
);
